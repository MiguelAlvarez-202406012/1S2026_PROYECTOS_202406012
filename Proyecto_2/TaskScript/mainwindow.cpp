...
void MainWindow::conectarUI(){
    ...
    connect(ui->btnReporte3, &QPushButton::clicked, this, &MainWindow::abrirReporte3);
    connect(ui->btnReporte4, &QPushButton::clicked, this, &MainWindow::abrirReporte4);
    connect(ui->btnReporte5, &QPushButton::clicked, this, &MainWindow::abrirReporte5);

    for (auto *btn : {ui->btnReporte1, ui->btnReporte2, ui->btnReporte3, ui->btnReporte4,ui->btnReporte5}) {
...
void MainWindow::cargarArchivo() {
    QString ruta = QFileDialog::getOpenFileName(
        this, "Abrir archivo .task", "", "Archivos MedLang (*.med);;Todos los archivos (*)");
    ...
    for (auto *btn : {ui->btnReporte1, ui->btnReporte2, ui->btnReporte3, ui->btnReporte4})
        btn->setEnabled(false);
